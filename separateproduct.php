		...
		<div class="col-md-12">
			<div class="zk-info-top-menu">
		        <ul> 
					...
					<li> / &nbsp;&nbsp;<a href="#"> Туфли Rieker артикул 11306-14</a></li>
		       	</ul>
			</div>
		</div>
	</div>
				...
				<div class="zk-right">
					<ul class="zk-right-boxs">
						<li>
							...
							<span>Бесплатная доставка и примерка (Самара)</span>
						</li>
						<li>
							<img src="/img/pro-2.png" alt="">
							<span>Сеть розничных магазинов</span>
						</li>
						<li>
							<img src="/img/pro-3.png" alt="">
							<span>Безналичная оплата Наложенный платеж</span>
						</li>
						<li>
